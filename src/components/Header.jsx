...
const Header = () => {
  ...
  return (
    <>
      <nav className="container sticky top-0 py-4 flex justify-between items-center shadow backdrop-blur-sm">
        <Link to="/">
          {/* <img src="/logo.png" className="h-20" /> */}
          <span className="self-center text-2xl font-extrabold tracking-widest">
            <span className="bg-gradient-to-r from-[#4338ca] to-purple-500 bg-clip-text text-transparent font-mono">
              PASSION
            </span>
