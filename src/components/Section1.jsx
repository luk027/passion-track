  ...
  return (
    <section className='custom-section-sroll text-center min-h-0 sm:min-h-screen flex flex-col justify-center items-center gradient-title'>
        <div>
          ...
          >
            Easy steps to 
            <span className="hidden lg:block"> {/* Hidden on small screens, block on large screens */}
                land your next job
            </span>
            <span className="lg:hidden"> {/* Visible on small screens, hidden on large screens */}
                land your next job
            </span>
          </h1>
        </div>

            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-4 py-8 sm:py-16'>

                {/* 1 card  */}
                <div className='flex flex-col items-center'>
                    <div className='bg-blue-600 text-white rounded-lg shadow-lg shadow-blue-400 h-20 w-20 flex justify-center items-center'>
                ...
                {/* 2 card  */}
                <div className='flex flex-col items-center'>
                    <div className='bg-green-600 text-white rounded-lg shadow-lg shadow-green-400 h-20 w-20 flex justify-center items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                ...
                <div className='flex flex-col md:col-span-2 lg:col-span-1 items-center'>
                    <div className='bg-yellow-400 text-white rounded-lg shadow-lg shadow-yellow-200 h-20 w-20 flex justify-center items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
